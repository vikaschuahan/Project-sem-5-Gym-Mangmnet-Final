...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    '%$$-76y4tl7sbv*e$acozc=$wjeua9d8g0l%y$&afj@1zo@f^+'  # fallback for dev only
)
...
# Database
# Uses DATABASE_URL env var in production (PostgreSQL), falls back to SQLite locally.
DATABASES = {
...
# WhiteNoise compression/caching support for serving static files efficiently
